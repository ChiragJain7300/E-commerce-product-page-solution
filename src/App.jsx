        ...
        <div className="md:py-16 pt-0 flex max-w-6xl flex-col md:flex-row justify-center md:mx-auto">
          ...
          <div className="flex flex-col px-3 lg:px-0 md:w-1/2 justify-center w-2/3 min-w-[375px] mx-auto">
            ...
            <div className="flex items-center gap-4 mb-2">
              ...
              <div className=" text-center rounded-md w-12 bg-black text-white text-md">
                50%
              </div>
            </div>
            ...
            <div className="flex gap-3 md:flex-row flex-col">
              ...
              <button
                className="md:w-52 w-full mx-auto md:mx-0 py-3 flex items-center gap-3 bg-Orange hover:bg-PaleOrange justify-center rounded-lg text-vdBlue font-bold"
                onClick={() =>
                  shoeOrdCount > 0
